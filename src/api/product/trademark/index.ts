...
export const reqHasTrademark = (page: number, limit: number) => request.get<any, TrademarkResponceData>(API.TRADEMARK_URL + `${page}/${limit}`)
...
export const reqDeleteTrademark = (id: number) => request.delete(API.DELETETREADEMARK_URL + id)